...
#include "interfaces_control_pkg/msg/detail/erp_status_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces_control_pkg::msg::ErpStatusMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces_control_pkg::msg::ErpStatusMsg & ros_message)
{
  // Member: control_mode
  cdr >> ros_message.control_mode;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces_control_pkg
max_serialized_size_ErpStatusMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_control_pkg::msg::ErpStatusMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces_control_pkg::msg::ErpStatusMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces_control_pkg::msg::ErpStatusMsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ErpStatusMsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const interfaces_control_pkg::msg::ErpStatusMsg *>(
...
static size_t _ErpStatusMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ErpStatusMsg(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ErpStatusMsg__callbacks = {
...
static rosidl_message_type_support_t _ErpStatusMsg__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ErpStatusMsg__callbacks,
...
{
  return &interfaces_control_pkg::msg::typesupport_fastrtps_cpp::_ErpStatusMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_control_pkg, msg, ErpStatusMsg)() {
  return &interfaces_control_pkg::msg::typesupport_fastrtps_cpp::_ErpStatusMsg__handle;
}
