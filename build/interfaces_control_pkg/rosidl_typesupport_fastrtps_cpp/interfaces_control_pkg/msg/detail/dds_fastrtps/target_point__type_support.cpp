...
#include "interfaces_control_pkg/msg/detail/target_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces_control_pkg::msg::TargetPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces_control_pkg::msg::TargetPoint & ros_message)
{
  // Member: target_x
  cdr >> ros_message.target_x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_control_pkg::msg::TargetPoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces_control_pkg::msg::TargetPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces_control_pkg::msg::TargetPoint *>(
    untyped_ros_message);
...
{
  return &interfaces_control_pkg::msg::typesupport_fastrtps_cpp::_TargetPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_control_pkg, msg, TargetPoint)() {
  return &interfaces_control_pkg::msg::typesupport_fastrtps_cpp::_TargetPoint__handle;
}
