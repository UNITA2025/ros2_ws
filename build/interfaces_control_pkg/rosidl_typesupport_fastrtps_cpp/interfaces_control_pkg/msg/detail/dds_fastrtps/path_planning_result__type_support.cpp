...
#include "interfaces_control_pkg/msg/detail/path_planning_result__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces_control_pkg::msg::PathPlanningResult & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces_control_pkg::msg::PathPlanningResult & ros_message)
{
  // Member: x_points
  {
    cdr >> ros_message.x_points;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_control_pkg::msg::PathPlanningResult;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces_control_pkg::msg::PathPlanningResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces_control_pkg::msg::PathPlanningResult *>(
    untyped_ros_message);
...
{
  return &interfaces_control_pkg::msg::typesupport_fastrtps_cpp::_PathPlanningResult__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_control_pkg, msg, PathPlanningResult)() {
  return &interfaces_control_pkg::msg::typesupport_fastrtps_cpp::_PathPlanningResult__handle;
}
