...
#include "interfaces_control_pkg/msg/detail/motion_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces_control_pkg::msg::MotionCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces_control_pkg::msg::MotionCommand & ros_message)
{
  // Member: steering
  cdr >> ros_message.steering;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_control_pkg::msg::MotionCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces_control_pkg::msg::MotionCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces_control_pkg::msg::MotionCommand *>(
    untyped_ros_message);
...
{
  return &interfaces_control_pkg::msg::typesupport_fastrtps_cpp::_MotionCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_control_pkg, msg, MotionCommand)() {
  return &interfaces_control_pkg::msg::typesupport_fastrtps_cpp::_MotionCommand__handle;
}
