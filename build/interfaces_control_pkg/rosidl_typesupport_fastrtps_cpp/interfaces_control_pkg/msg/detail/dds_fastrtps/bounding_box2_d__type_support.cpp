...
#include "interfaces_control_pkg/msg/detail/bounding_box2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const interfaces_control_pkg::msg::Vector2 &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  interfaces_control_pkg::msg::Vector2 &);
size_t get_serialized_size(
  const interfaces_control_pkg::msg::Vector2 &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const interfaces_control_pkg::msg::BoundingBox2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces_control_pkg::msg::BoundingBox2D & ros_message)
{
  // Member: center
  ...
  size_t current_alignment)
{
  ...
  // Member: size
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces_control_pkg::msg::typesupport_fastrtps_cpp::max_serialized_size_Vector2(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_control_pkg::msg::BoundingBox2D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces_control_pkg::msg::BoundingBox2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces_control_pkg::msg::BoundingBox2D *>(
    untyped_ros_message);
...
get_message_type_support_handle<interfaces_control_pkg::msg::BoundingBox2D>()
{
  return &interfaces_control_pkg::msg::typesupport_fastrtps_cpp::_BoundingBox2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_control_pkg, msg, BoundingBox2D)() {
  return &interfaces_control_pkg::msg::typesupport_fastrtps_cpp::_BoundingBox2D__handle;
}
