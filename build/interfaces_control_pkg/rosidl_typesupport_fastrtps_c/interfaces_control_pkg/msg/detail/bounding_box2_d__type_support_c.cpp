...
#include "interfaces_control_pkg/msg/detail/bounding_box2_d__rosidl_typesupport_fastrtps_c.h"
...
#include "interfaces_control_pkg/msg/detail/vector2__functions.h"  // size
#include "interfaces_pkg/msg/detail/pose2_d__functions.h"  // center

// forward declare type support functions
size_t get_serialized_size_interfaces_control_pkg__msg__Vector2(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_interfaces_control_pkg__msg__Vector2(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces_control_pkg, msg, Vector2)();
...
using _BoundingBox2D__ros_msg_type = interfaces_control_pkg__msg__BoundingBox2D;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: size
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, interfaces_control_pkg, msg, Vector2
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_interfaces_control_pkg__msg__Vector2(
...
static uint32_t _BoundingBox2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces_control_pkg__msg__BoundingBox2D(
  ...
  size_t current_alignment)
{
  ...
  // member: size
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_interfaces_control_pkg__msg__Vector2(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_control_pkg__msg__BoundingBox2D;
    is_plain =
      (
...
static size_t _BoundingBox2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces_control_pkg__msg__BoundingBox2D(
