...
bool interfaces_control_pkg__msg__erp_status_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces_control_pkg.msg._erp_status_msg.ErpStatusMsg", full_classname_dest, 55) == 0);
  }
  interfaces_control_pkg__msg__ErpStatusMsg * ros_message = _ros_message;
  {  // control_mode
...
{
  /* NOTE(esteve): Call constructor of ErpStatusMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces_control_pkg.msg._erp_status_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ErpStatusMsg");
