...
class Metaclass_KeyPoint3DArray(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from interfaces_control_pkg.msg import KeyPoint3D
...
class KeyPoint3DArray(metaclass=Metaclass_KeyPoint3DArray):
    ...
    _fields_and_field_types = {
        'data': 'sequence<interfaces_control_pkg/KeyPoint3D>',
        'frame_id': 'string',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['interfaces_control_pkg', 'msg'], 'KeyPoint3D')),  # noqa: E501
