...
class Metaclass_ErpCmdMsg(type):
    """Metaclass of message 'ErpCmdMsg'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'interfaces_control_pkg.msg.ErpCmdMsg')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__erp_cmd_msg
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__erp_cmd_msg
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__erp_cmd_msg
            cls._TYPE_SUPPORT = module.type_support_msg__msg__erp_cmd_msg
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__erp_cmd_msg
...
class ErpCmdMsg(metaclass=Metaclass_ErpCmdMsg):
    """Message class 'ErpCmdMsg'."""
