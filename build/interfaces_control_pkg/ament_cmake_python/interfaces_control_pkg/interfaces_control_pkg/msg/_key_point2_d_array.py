...
class Metaclass_KeyPoint2DArray(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from interfaces_control_pkg.msg import KeyPoint2D
...
class KeyPoint2DArray(metaclass=Metaclass_KeyPoint2DArray):
    ...
    _fields_and_field_types = {
        'data': 'sequence<interfaces_control_pkg/KeyPoint2D>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['interfaces_control_pkg', 'msg'], 'KeyPoint2D')),  # noqa: E501
    )
