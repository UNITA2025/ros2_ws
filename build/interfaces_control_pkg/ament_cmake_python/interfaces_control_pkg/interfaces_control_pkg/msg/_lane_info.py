    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'interfaces_control_pkg.msg.LaneInfo')
            logger.debug(
            ...
            from interfaces_control_pkg.msg import TargetPoint
...
class LaneInfo(metaclass=Metaclass_LaneInfo):
    ...
    _fields_and_field_types = {
        'slope': 'float',
        'target_points': 'sequence<interfaces_control_pkg/TargetPoint>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('float'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['interfaces_control_pkg', 'msg'], 'TargetPoint')),  # noqa: E501
    )
