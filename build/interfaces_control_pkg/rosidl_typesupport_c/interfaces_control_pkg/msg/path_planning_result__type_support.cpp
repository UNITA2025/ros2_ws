...
static const _PathPlanningResult_type_support_symbol_names_t _PathPlanningResult_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces_control_pkg, msg, PathPlanningResult)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces_control_pkg, msg, PathPlanningResult)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, interfaces_control_pkg, msg, PathPlanningResult)() {
  return &::interfaces_control_pkg::msg::rosidl_typesupport_c::PathPlanningResult_message_type_support_handle;
}
