...
static const _KeyPoint3DArray_type_support_symbol_names_t _KeyPoint3DArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces_control_pkg, msg, KeyPoint3DArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces_control_pkg, msg, KeyPoint3DArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, interfaces_control_pkg, msg, KeyPoint3DArray)() {
  return &::interfaces_control_pkg::msg::rosidl_typesupport_c::KeyPoint3DArray_message_type_support_handle;
}
