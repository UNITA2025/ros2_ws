...
class Detection(metaclass=Metaclass_Detection):
    ...
    _fields_and_field_types = {
        ...
        'score': 'double',
        'id': 'string',
        'bbox': 'interfaces_control_pkg/BoundingBox2D',
        'bbox3d': 'interfaces_control_pkg/BoundingBox3D',
        'mask': 'interfaces_control_pkg/Mask',
        'keypoints': 'interfaces_control_pkg/KeyPoint2DArray',
        'keypoints3d': 'interfaces_control_pkg/KeyPoint3DArray',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['interfaces_control_pkg', 'msg'], 'BoundingBox2D'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['interfaces_control_pkg', 'msg'], 'BoundingBox3D'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['interfaces_control_pkg', 'msg'], 'Mask'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['interfaces_control_pkg', 'msg'], 'KeyPoint2DArray'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['interfaces_control_pkg', 'msg'], 'KeyPoint3DArray'),  # noqa: E501
    )
