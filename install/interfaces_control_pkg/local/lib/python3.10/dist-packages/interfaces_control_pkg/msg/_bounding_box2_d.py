...
class Metaclass_BoundingBox2D(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from interfaces_control_pkg.msg import Vector2
            if Vector2.__class__._TYPE_SUPPORT is None:
                Vector2.__class__.__import_type_support__()

            from interfaces_pkg.msg import Pose2D
...
class BoundingBox2D(metaclass=Metaclass_BoundingBox2D):
    ...
    _fields_and_field_types = {
        'center': 'interfaces_pkg/Pose2D',
        'size': 'interfaces_control_pkg/Vector2',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['interfaces_pkg', 'msg'], 'Pose2D'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['interfaces_control_pkg', 'msg'], 'Vector2'),  # noqa: E501
    )
