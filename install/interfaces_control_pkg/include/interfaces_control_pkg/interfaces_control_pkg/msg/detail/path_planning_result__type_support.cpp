...
{
  new (message_memory) interfaces_control_pkg::msg::PathPlanningResult(_init);
}

void PathPlanningResult_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces_control_pkg::msg::PathPlanningResult *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PathPlanningResult_message_member_array[2] = {
  {
    ...
    offsetof(interfaces_control_pkg::msg::PathPlanningResult, x_points),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces_control_pkg::msg::PathPlanningResult, y_points),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PathPlanningResult_message_members = {
  ...
  2,  // number of fields
  sizeof(interfaces_control_pkg::msg::PathPlanningResult),
...
get_message_type_support_handle<interfaces_control_pkg::msg::PathPlanningResult>()
{
  return &::interfaces_control_pkg::msg::rosidl_typesupport_introspection_cpp::PathPlanningResult_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces_control_pkg, msg, PathPlanningResult)() {
  return &::interfaces_control_pkg::msg::rosidl_typesupport_introspection_cpp::PathPlanningResult_message_type_support_handle;
}
